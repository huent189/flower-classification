...
class VGG(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.layer1 = nn.Sequential(nn.Conv2d(3, 64,kernel_size =(3,3), stride=1, padding=1), nn.Conv2d(64, 64, (3,3), 1, 1), nn.MaxPool2d((2,2),2), nn.ReLU())
        self.layer2 = nn.Sequential(nn.Conv2d(64, 128, (3,3), 1, 1), nn.Conv2d(128, 128, (3,3), 1, 1), nn.MaxPool2d((2,2),2), nn.ReLU())
